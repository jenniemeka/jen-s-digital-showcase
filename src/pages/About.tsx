      ...
      <Section>
        <div ref={heroRef} className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="max-w-2xl">
            ...
            >
              I'm an AI product engineer and tech founder. I build digital tools that solve real problems, and I spend just as much time teaching the next generation of African builders how to write their first lines of code.
            </motion.p>
          </div>
        </div>
      </Section>
